...
- 🛠️ **Favorite Stack:** TypeScript + Next.js + Go.
- 🚗 **Hardware modding:** Making hardware open and useful.

---

### 🏠 My Lab (Self-Hosted Services)
...
- 🚗 **[carthing-non-premium-spotify](https://github.com/williamtcastro/carthing-non-premium-spotify)**
  *Bypassing restrictions and giving new life to Spotify's Car Thing hardware.*
- 🌅 **[spaceship-sunset](https://github.com/williamtcastro/spaceship-sunset)**
  *Dynamic theme engine for seamless synchronization across terminal tools.*
- ⌨️ **[shortcuts-tui](https://github.com/williamtcastro/shortcuts-tui)**
  *Go-powered terminal interface for managing documentation and shell power-tools.*
